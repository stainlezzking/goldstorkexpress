      ...
      <div className="bg-white/10">
        <div className={"mx-auto " + maxWidthConstant}>
          <div className="flex gap-x-3 items-center py-5 bg-secondary ps-7 pe-16 w-fit">
            <svg className="w-10" viewBox="0 0 29 25" fill="none">
        ...
        <div className="w-fit px-7  max-md:gap-y-10 grid gap-x-10 grid-cols-2 md:grid-cols-4 lg:grid-cols-5 py-14">
          <div className="col-span-2 space-y-2">
            <p className="text-[#E8E8E8]">
              GoldStorkExpress is a leading logistics and delivery service based in England, dedicated to providing reliable and efficient shipping solutions
              locally and globally. With a commitment to excellence and customer satisfaction, we strive to simplify logistics challenges and deliver peace of
          ...
          <div className="col-span-2 lg:grid-col-span-3 max-sm:space-y-6 sm:flex gap-x-5">
            <div className="space-y-5 text-white">
              <div className="flex gap-x-2 items-center">
                <svg className="w-10 shrink-0" viewBox="0 0 64 64" fill="none">
              ...
              <div className="flex gap-x-2 items-center">
                <svg className="w-10 shrink-0" viewBox="0 0 63 63" fill="none">
            ...
            <div className="col-span-1 space-y-1 ps-3 text-white">
              <Link href="#" className="block py-1 hover:text-white/70">
                About Us
              </Link>
              <Link href="#" className="block py-1 hover:text-white/70">
                Our Team
              ...
              <Link href="/blogs" className="block py-1 hover:text-white/70">
                Blogs
              </Link>
            </div>
          </div>
