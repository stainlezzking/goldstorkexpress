...
export default function Button({ children, variation, className, ...props }) {
  return (
    <button
      {...props}
      className={twMerge(
        `block text-white px-10 py-3 w-fit mx-auto my-3 relative overflow-hidden ${
          variation ? variations[variation] : "default"
