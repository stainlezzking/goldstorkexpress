          ...
          <div className="col-span-1 px-10 py-10 space-y-10">
            <div className="flex items-start gap-x-5 max-w-[450px]">
              ...
              <div>
                ...
                <p className="text-paragraph">
                  We utilize state-of-the-art facilities equipped with advanced inventory management systems to ensure optimal storage conditions and
                  easy accessibility.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-x-5 max-w-[450px]">
              ...
              <div>
                ...
                <p className="text-paragraph">
                  Our operations incorporate eco-friendly initiatives such as energy-efficient warehousing, optimized transportation routes to reduce
