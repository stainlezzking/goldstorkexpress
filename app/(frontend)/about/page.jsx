...
import banner from "@/app/assets/pages-banner/about.png";
              ...
              <Tabs defaultValue="account" className="flex flex-col justify-center py-3 space-y-2">
                ...
                <div className="justify-self-stretch">
                  <TabsContent value="account">
                    At GoldStorkExpress, we redefine delivery with a commitment to reliability, efficiency, and unparalleled customer service. Based in the
                    heart of England, we pride ourselves on connecting businesses and individuals across the globe with seamless logistics solutions. Whether
                    you're sending a parcel across town or shipping freight internationally, GoldStorkExpress is your trusted partner every step of the way.
                  </TabsContent>
                  <TabsContent value="password">
                    As the world’s leading logistics company, we have a responsibility to set an example in our industry and be a sustainability leader. That
                    means reducing our carbon footprint and setting the highest social and governance standards. Over the years, we have repeatedly redefined
                    logistics, from pioneering the first green logistics product to becoming the first logistics company to commit to a zero-emissions target.
                    Today we offer the most comprehensive portfolio of green logistics solutions in the industry.
                    <br />
                    <br />
                    Sustainability is our responsibility – the decisions we make today can make a positive impact on tomorrow. Discover how our green logistics
                    products and solutions can minimize your carbon emissions without compromising your supply chain.
                  </TabsContent>
                  <TabsContent value="approach">
                    GoldStorkExpress began with a vision to revolutionize the logistics industry. With a foundation built on decades of expertise and a deep
                    understanding of global shipping dynamics, we have grown to become a cornerstone in the delivery sector. Our journey is shaped by a
                    relentless pursuit of excellence, ensuring that every package entrusted to us arrives on time and in pristine condition.
                  </TabsContent>
                </div>
              </Tabs>
            </div>
