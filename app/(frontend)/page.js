  ...
  return (
    <div>
      <div className="relative">
        <Image src={banner} alt="" className="max-md:h-[60vh] max-[1200px]:aspect-video object-cover" />
      ...
      <section className={`relative  pt-[200px] bg-[url('./container.png')] bg-no-repeat bg-top `}>
        <div className="p-3 md:p-10 lg:p-20 mx-auto  bg-white grid grid-cols-12  max-lg:max-w-[90%] max-w-[1000px]">
          ...
          <div className="max-lg:order-1 col-span-full lg:col-span-7">
            <Image src={plane} alt="" className="max-w-[500px] mx-auto w-full" />
          </div>
        </div>
      </section>
      ...
      <div className="py-16 space-y-4 container mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5">
          ...
          <div className="col-grid-1 relative">
            <Image src={packagesolution} alt="" className="w-full" />
            <span className="block absolute bottom-0 left-0 bg-gradient-to-t from-black h-1/3  w-full"></span>
            <div className="absolute bottom-0 left-0 w-full text-center py-2">
          ...
          <div className="col-grid-1 relative">
            <Image src={logistics} alt="" className="w-full" />
            <span className="block absolute bottom-0 left-0 bg-gradient-to-t from-black h-1/3  w-full"></span>
            <div className="absolute bottom-0 left-0 w-full text-center py-2">
          ...
          <div className="col-grid-1 relative">
            <Image src={warehouse} alt="" className="w-full" />
            <span className="block absolute bottom-0 left-0 bg-gradient-to-t from-black h-1/3  w-full"></span>
            <div className="absolute bottom-0 left-0 w-full text-center py-2">
          ...
          <div className="col-grid-1 relative">
            <Image src={specializedtransport} alt="" className="w-full" />
      ...
      <section className={"py-16 mx-auto max-lg:container max-w-[800px] space-y-[15px]"}>
        ...
        <Link href="/blogs" className="pt-5 block">
          <Button variation="primary">More Blog</Button>
        </Link>
      </section>

      <div>
        <Image src={footerImage} alt="" className="w-full" />
        <Footer />
      </div>
    </div>
  );
