      ...
      <section className="bg-white">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section className="relative flex h-32 items-end lg:col-span-5 lg:h-full xl:col-span-6">
            <Image alt="" src={login} className="absolute inset-0 h-full w-full object-cover opacity-80" />
            ...
            <div className="hidden lg:relative lg:block lg:p-12">
              ...
              <h2 className="mt-6 text-2xl font-bold text-secondary sm:text-3xl md:text-4xl">Delivering Your World, One Package at a Time</h2>

              <p className="mt-4 leading-relaxed text-secondary/90">
                Your deliveries, our priority. Experience fast, reliable, and secure shipping with Gold Stork Express
              </p>
            </div>
          </section>
          ...
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              ...
              <form action="/auth/" className="mt-8 grid grid-cols-6 gap-6">
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <input
                    ...
                    id="FirstName"
                    name="first_name"
                    className="mt-1 w-full py-2 ps-1 rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                  />
                </div>
